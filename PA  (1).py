...
def simpan_daftar_kamar():
    with open("daftar_kamar.json", "w") as kamar_file:
        ...
        json.dump(daftar_kamar_json, kamar_file, indent=4)
        ...
        try:
            ...
            for kamar in daftar_kamar:
                if kamar["nomor_kamar"] == no_kamar:
                    ...
                    return
                elif kamar["nomor_kamar"] != no_kamar: 
...
def ubah_daftar_kamar():
    while True:
        try: 
            ...
            print("+---------------------------------------------------------+")
            print("|                MEMPERBARUI DAFTAR KAMAR                 |")
            print("+---------------------------------------------------------+")
...
def tambah_saldo_customer():
    while  True:
        try:
            os.system("cls")
            print("==============| MASUKKAN ID |=================")  
            customer_id = int(input("Masukkan id anda : "))
            jumlah_topup = 0

            # Inisialisasi customer_data
            with open("data_login.json", "r") as customer_file:
                ...
                if kamar["nomor_kamar"] == no_kamar and kamar["status"] == "tersedia":
                    ...
                    for customer_username, data in customer_data.items():
                        if data["id"] == customer_id:
                            ...
                            with open("data_login.json", "w") as customer_file:
                                json.dump(customer_data, customer_file,indent=5)
                            return
                    print(f"Customer dengan ID {customer_id} tidak ditemukan.")
                    return
...
while True:
        try:
            ...
            if role == 1:
                        ...
                        try:
                            while True:
                                ...
                                if pilih == 1:
                                    ...
                                    konfirmasi = input("Apakah anda yakin ingin keluar dari menu admin ? y/t :")
                                    if konfirmasi == "y":
                        ...
                        try:
                            if pilih_customer == 1:
                                ...
                                while kesempatan > 0:
                                    ...
                                    customer_id = int(input("Masukkan nama id anda : "))
                                ...
                                if customer_username not in customer_data:
                                    customer_id = len(customer_data)+100
                                    customer_saldo = 0
                ...
                print("|        +----------------------------+          |")
                print("#================================================#")
                konfirmasi = input("Apakah anda yakin ingin keluar dari program kami? y/t :")
                if konfirmasi == "y":
                    print("Terima kasih telah menggunakan layanan kami.")  
                    break
                else:
